...
FileName <- "Avg.Return and Correlation Data.xlsx"
NumberofYears <- 20
NumberofSimulations <- 100000

Percentiles <- c(5,10,25,50,75,90,95)
Probabilities <- c(9,8,7,6.5,6,5.5,5)
FundARR <- 0.07
#
...
colnames(table) <- c("Potential Rates of Return",
                     "Average Historical Returns",
                     "Average Plan Assumptions",
...
table <- width(table, j = 1, width = 3.5)
table <- width(table, j = 1:9, width = 3)
table
